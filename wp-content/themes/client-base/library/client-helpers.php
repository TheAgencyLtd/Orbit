...
/*
 * Adds Google analytics tracking code to header
 */
...
/**
 * Runs Google Analytics tracking code after succesfull
 * form submission with ContactForm7.
 * Allowing form submissions to be tracked.
 */
function contact_form_ga_tracker() {
    ?>
...
add_action( 'wp_footer', 'contact_form_ga_tracker' );